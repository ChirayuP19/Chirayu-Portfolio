            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="contact_info">
                        ...
                        <div class="info_item">
                            ...
                            <h6>
                                <a href="#">chirayu010675@gmail.com</a>
                            </h6>
                ...
                <div class="col-lg-9">
                    <form action="${pageContext.request.contextPath}/client/savecontact"
                        method="post" class="row contact_form"
                        action="${pageContext.request.contextPath}/contact_process.php"
                        id="contactForm" novalidate="novalidate">
                        <div class="col-md-6">

                            <c:forEach var="err" items="${errors}">
                                <c:if test="${err.field eq 'name'}">
                                    <span class="text-danger">${err.defaultMessage}</span>
                                </c:if>
                            </c:forEach>
                            ...
                            <c:forEach var="err" items="${errors}">
                                <c:if test="${err.field eq 'subject'}">
                                    <span class="text-danger">${err.defaultMessage}</span>
                                </c:if>
                            </c:forEach>
                        ...
                        <div class="col-md-6">
                            ...
                            <c:forEach var="err" items="${errors}">
                                <c:if test="${err.field eq 'message'}">
                                    <span class="text-danger">${err.defaultMessage}</span>
                                </c:if>
                            </c:forEach>
